const translations = {
    ...
    fr: {
        ...
        add_photo_modal_intro: "Vous avez une photo de ce terrain à partager ? Proposez-la, elle sera vérifiée avant publication.",
        add_photo_modal_osm_savvy: "Vous êtes déjà familier avec l'édition OpenStreetMap ? Ajoutez le tag mapillary= (ou wikimedia_commons=) sur le nœud de ce terrain, pointant vers une photo déjà présente sur Mapillary ou Wikimedia Commons — elle sera reprise automatiquement lors de notre prochaine mise à jour, sans passer par ce formulaire.",
        add_photo_field_photo_label: "Votre photo",
        add_photo_file_hint: "5 Mo maximum",
        add_photo_field_email_label: "Votre e-mail (facultatif, pour vous recontacter si besoin)",
        add_photo_checkbox_label: "J'autorise Mapetanque.be à publier cette photo sur Mapillary sous licence CC BY-SA (avec mention de mon prénom/pseudo si je le renseigne ci-dessus).",
        ...
        add_photo_error_too_large: "Cette photo est trop volumineuse (5 Mo maximum), choisissez une photo plus légère.",
    ...
    nl: {
        ...
        add_photo_modal_intro: "Heb je een foto van dit terrein om te delen? Stuur ze door, ze wordt gecontroleerd voor publicatie.",
        add_photo_modal_osm_savvy: "Al vertrouwd met OpenStreetMap bewerken? Voeg de tag mapillary= (of wikimedia_commons=) toe aan het punt van dit terrein, verwijzend naar een foto die al op Mapillary of Wikimedia Commons staat — ze wordt automatisch overgenomen bij onze volgende update, zonder dit formulier te gebruiken.",
        add_photo_field_photo_label: "Uw foto",
        add_photo_file_hint: "Maximaal 5 MB",
        add_photo_field_email_label: "Uw e-mail (optioneel, om u eventueel opnieuw te contacteren)",
        add_photo_checkbox_label: "Ik geef Mapetanque.be toestemming om deze foto op Mapillary te publiceren onder de CC BY-SA-licentie (met vermelding van mijn voornaam/gebruikersnaam indien hierboven ingevuld).",
        ...
        add_photo_error_too_large: "Deze foto is te groot (maximaal 5 MB), kies een lichtere foto.",
    ...
    de: {
        ...
        add_photo_modal_intro: "Haben Sie ein Foto von diesem Platz, das Sie teilen möchten? Schicken Sie es uns, es wird vor der Veröffentlichung geprüft.",
        add_photo_modal_osm_savvy: "Sie kennen sich bereits mit dem Bearbeiten von OpenStreetMap aus? Fügen Sie dem Knotenpunkt dieses Platzes das Tag mapillary= (oder wikimedia_commons=) hinzu, das auf ein bereits vorhandenes Foto bei Mapillary oder Wikimedia Commons verweist — es wird bei unserer nächsten Aktualisierung automatisch übernommen, ohne dieses Formular zu nutzen.",
        add_photo_field_photo_label: "Ihr Foto",
        add_photo_file_hint: "Maximal 5 MB",
        add_photo_field_email_label: "Ihre E-Mail (optional, falls wir Sie kontaktieren müssen)",
        add_photo_checkbox_label: "Ich erlaube Mapetanque.be, dieses Foto unter der CC-BY-SA-Lizenz auf Mapillary zu veröffentlichen (mit Nennung meines Vornamens/Benutzernamens, falls oben angegeben).",
        ...
        add_photo_error_too_large: "Dieses Foto ist zu groß (maximal 5 MB), bitte wählen Sie ein kleineres Foto.",
